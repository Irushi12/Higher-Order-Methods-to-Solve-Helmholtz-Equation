...
for i=3:N
    ii = Number(1,i);       
    B(ii) = (1-2*((1/(k*h^2)) + (2/15))+6*(1/(20*h^2*k)))*uy0(i)...
        +(((1/(k*h^2)) + (2/15)) ...
        - 4*(1/(20*h^2*k)))*uy0(i+1)+(((1/(k(x(1),y(i)-h)*h^2)) + (2/15)) ...
        - 4*(1/(20*h^2*k)))*uy0(i-1)...
        +(1/(20*h^2*k))*uy0(i+2)...
        +(1/(20*h^2*k))*uy0(i-2);
    ii = Number(N+2,i);     
    B(ii) = (1-2*((1/(k) + (2/15))+6*(1/(20*h^2*k)))*uyend2(i)...
        +(((1/(k*h^2)) + (2/15)) ...
        - 4*(1/(20*h^2*k)))*uyend2(i+1)+(((1/(k*h^2)) + (2/15)) ...
        - 4*(1/(20*h^2*k)))*uyend2(i-1) ...
        +(1/(20*h^2*k))*uyend2(i+2) ...
        +(1/(20*h^2*k))*uyend2(i-2);
end
% solving for U_star
...
for i=3:N
    for j=3:N
        ii = Number(i,j);
        A1(ii,ii) = 1-2*((1/(k) + (2/15))+6*(1/(20*h^2*k));
